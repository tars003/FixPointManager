...
// Mock vehicles data (would be fetched from API)
const mockVehicles: VehicleModelData[] = [
  {
    ...
    year: 2023,
    modelCode: 'THAR2023',
    thumbnailUrl: 'https://imgd.aeplcdn.com/1280x720/n/cw/ec/40087/thar-exterior-right-front-three-quarter-11.jpeg?q=80',
    description: 'The iconic Mahindra Thar with modern updates and off-road capabilities.',
    basePrice: 1500000,
    popularity: 9,
    colors: [
      { id: 'red', name: 'Rocky Red', hex: '#7C0A02', type: 'standard', price: 0 },
      { id: 'black', name: 'Napoli Black', hex: '#1a1a1a', type: 'standard', price: 0 },
      { id: 'white', name: 'Pearl White', hex: '#f2f2f2', type: 'metallic', price: 15000 },
    ]
  },
  {
    id: 2,
    ...
    year: 2023,
    modelCode: 'CRETA2023',
    thumbnailUrl: 'https://imgd.aeplcdn.com/1200x900/n/cw/ec/141115/creta-exterior-right-front-three-quarter-2.jpeg?isig=0&q=80',
    description: 'The popular Hyundai Creta with modern styling and premium features.',
    basePrice: 1200000,
    popularity: 8,
    colors: [
      { id: 'blue', name: 'Marina Blue', hex: '#1a5276', type: 'metallic', price: 12000 },
      { id: 'silver', name: 'Typhoon Silver', hex: '#c0c0c0', type: 'metallic', price: 12000 },
      { id: 'white', name: 'Polar White', hex: '#f9f9f9', type: 'standard', price: 0 },
    ]
  },
  {
    id: 3,
    ...
    year: 2023,
    modelCode: 'RE-CL350',
    thumbnailUrl: 'https://imgd.aeplcdn.com/1280x720/n/cw/ec/44686/right-front-three-quarter.jpeg?q=80',
    description: 'The legendary Royal Enfield Classic 350 with timeless design and modern engineering.',
    basePrice: 190000,
    popularity: 9,
    colors: [
      { id: 'red', name: 'Redditch Red', hex: '#C23B22', type: 'standard', price: 0 },
      { id: 'green', name: 'Military Green', hex: '#4B5320', type: 'matte', price: 5000 },
      { id: 'chrome', name: 'Chrome Bronze', hex: '#CD7F32', type: 'special', price: 10000 },
    ]
  }
];
